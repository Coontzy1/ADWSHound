...
# The LDAP_SERVER_SD_FLAGS control (1.2.840.113556.1.4.801) is carried on the **Pull**
# message (see LDAP_PULL_FSTRING), NOT the Enumerate — this is how SoaPy/ADWS actually
# applies it. Without it AD/ADWS omits nTSecurityDescriptor for non-privileged callers,
# so ACLs come back empty. controlValue base64 "MIQAAAADAgEH" = 30 84 00 00 00 03 02 01 07
# (SEQUENCE{INTEGER 7} with .NET long-form length) → Owner|Group|DACL, no SACL.
